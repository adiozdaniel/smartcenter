        ...
        <div className="flex w-full justify-center items-center" >
            <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4" >
                <div className="flex flex-1 justify-start flex-col mf:mr-10">
                    ...
                    >Explore the crypto world. Buy and sell cryptocurrencies easily on Dashoh
                    </p>
                    <button
                        type="button"
                    ...
                    <div
                        className="grid sm:grid-col-2 grid-cols-3  w-full text-white"
                    >
                ...
                <div className='flex flex-col flex-1 items-center justify-start w-full mf:mt-o mt-10' >
